		...
		<div class="page-header">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?php echo base_url('superadmin/administrator/careers_department');?>">Careers department</a></li>
						...
						<form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
							<div class="form-row">
								<div class="col-md-8 mb-3">
									<label for="name">Careers department*</label>
									<input class="form-control" name="name" placeholder="Enter Careers Department Name" value="<?php echo isset($edit['name']) ? $edit['name'] :'';?>" id="name" required>
								</div>
