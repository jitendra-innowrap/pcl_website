		...
		<div class="page-header">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?php echo base_url('superadmin/administrator/faqs_category');?>">FAQ Category</a></li>
						...
						<form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
							<div class="form-row">
								<div class="col-md-6 mb-3">
									...
									<input class="form-control" name="name" placeholder="Enter FAQ Category Name" value="<?php echo isset($edit['name']) ? $edit['name'] :'';?>" id="name" required>
								</div>
