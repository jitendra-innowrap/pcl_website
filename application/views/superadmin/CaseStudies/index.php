				...
				<div class="card">
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-bordered" id="data_table" data-function="CaseStudies_list">
								<thead>
								<tr>
									<th>#</th>
									<th>Brand</th>
...
<script>
	$(document).ready(function() {
        ...
        $.ajax({
            url: '<?php echo base_url("superadmin/administrator/enabled_disabled_success_story"); ?>',
            type: 'POST',
            data: { id: dataId},
