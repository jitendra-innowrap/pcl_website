          ...
          <form action="<?php echo base_url("console/add_contact"); ?>" method="POST"
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                ...
                <div class="d-flex form-group form-icon-left">
                  <select id="countryCode" name="countryCode" class="form-control style-border"
                    style="max-width: 100px;padding: 0px 20px;">
                    ...
                    <option value="84">(+1284) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Virgin Islands - British</option>
                    <option value="84">(+1340) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Virgin Islands - US </option>
              ...
              <div class="col-lg-4" id="otherEventContainer" style="display:none;">
                ...
                <div class="">
                  <input type="text" class="form-control style-border" name="otherEvent" id="otherEvent"
