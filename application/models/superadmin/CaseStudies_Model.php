...
class CaseStudies_Model extends CI_Model
{
	...
	{
		$this->db->select('cs.id,cs.title,cs.image,cs.author,cs.case_date,csc.name,cs.order_no,cs.status,cs.created_date');
		$this->db->join('casestudies_category csc','csc.id=cs.case_s_id','left');
