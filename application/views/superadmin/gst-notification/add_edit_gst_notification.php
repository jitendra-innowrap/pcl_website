		...
		<div class="page-header">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?php echo base_url('superadmin/administrator/newroom');?>">GST Notification</a></li>
						...
						<form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
							<div class="form-row">
								...
								<div class="col-md-3 mb-3">
									...
									<input class="form-control" name="notification_date" value="<?php echo isset($edit['notification_date'])?$edit['notification_date']:'';?>" type="date" required>
								</div>
								<div class="col-md-3 mb-3">
								...
								<div class="col-md-12 mb-3">
									...
									<textarea class="form-control" name="sort_desc" required><?php echo isset($edit['sort_desc'])?$edit['sort_desc']:'';?></textarea>
								</div>
